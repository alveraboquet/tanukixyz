...
export const CreamConfig: CompoundLendingConfig = {
	name: 'ironbank',
	pools: [
		// bsc
		{
		...
		// polygon
		{
			...
			poolAddress: '0x3fae5e5722c51cdb5b0afd8c7082e8a6af336ee8',
			underlyingSymbol: 'MATIC',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'matic-token',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x73CF8c5D14Aa0EbC89f18272A568319F5BAB6cBD',
			underlyingSymbol: 'USDC',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0xf976C9bc0E16B250E0B1523CffAa9E4c07Bc5C8a',
			underlyingSymbol: 'USDT',
			underlyingDecimals: 6,
			underlyingCoingeckoId: 'tether',
		},
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x7ef18d0a9C3Fb1A716FF6c3ED0Edf52a2427F716',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x5Dc3A30d8c5937f1529C3c93507C16d86A17072A',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x20d5d319C2964ecb52e1B006a4C059b7f6d6ad0a',
			underlyingSymbol: 'LINK',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'chainlink',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x468a7BF78f11Da82c90b17a93adb7B14999aF5AB',
			underlyingSymbol: 'SUSHI',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'sushi',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0xE82225bA6BeD28406912522F01C7102DD9f07e78',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x2eE80614Ccbc5e28654324a66A396458Fa5cD7Cc',
			underlyingSymbol: 'QUICK',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'quick',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x4486835e0c567a320c0636d8f6e6e6679a46a271',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0xfBbfa5fd64246046e683c423aa2AB0470fbD328D',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x9B21EB2E30D8320c3c1b8d8465284D78E58cB971',
			underlyingSymbol: 'FXS',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'frax-share',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0xd4409B8D17d5d49a7ed9Ae734B0E8EdBa29b9FFA',
		...
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x7ea7174dD0CB4Ab84f42177F01e9a8a79475d381',
			underlyingSymbol: 'UNI',
			underlyingDecimals: 18,
			underlyingCoingeckoId: 'uniswap',
		},
		{
			chainConfig: getChainConfig('polygon'),
			poolAddress: '0x98182BF525A4252C436ac349a4b79c7E6cd0EB7A',
